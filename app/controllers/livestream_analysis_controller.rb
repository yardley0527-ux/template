...
class LivestreamAnalysisController < ApplicationController
  ...
  EVENTS_2025 = [
    ...
    { date: Date.new(2025,  3, 10), label: "3/10",  year: 2025, note: "薑黃+B群+全能",
    ...
    { date: Date.new(2025,  5,  9), label: "5/9",   year: 2025, note: "B群+全能",
    ...
    { date: Date.new(2025,  9,  4), label: "9/4",   year: 2025, note: "B群+全能+NMN",
  ...
  EVENTS_2026 = [
    ...
    { date: Date.new(2026,  5, 22), label: "5/22", year: 2026, note: "穀胱甘肽、代謝錠、清纖粉、益生菌",
