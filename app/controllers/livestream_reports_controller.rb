    ...
    "魚油" => [
      {
        ...
        desc: "直播前診斷：15個月買氣走勢（4月起近乎歸零，回補後仍未回升）、4場歷史場次比較（客單價/黑卡/24h佔比）、逐場買家與新客趨勢、4場逐時賣貨速度、最終定價（1/3/6+1/10+2盒）、進貨2000盒預估營收$327萬、6/20首場29天完整銷售時間線＋卡別分布（黑卡佔箱量29.8%但買家僅14.5%）",
      },
    ],
  }.freeze
