  ...
  REPORTS = {
    ...
    "魚油" => [
      ...
      },
      {
        ...
        date: Date.new(2026, 9, 4),
        type: :post,
        url: "https://claude.ai/code/artifact/e53b57a0-f79d-4fc1-aa84-8c9c96cf2057",
        desc: "買家名單版：61位買家（新客5・舊客56），賣出636瓶／營收$966,000。0位新客大單、87位鐵粉流失（84%已收9/4傳訊名單仍未轉化）、1位快要吃完、25位舊客買更多、0位買很少——斷貨異常出現轉機但尚未解除",
      },
      {
        title: "魚油直播決策報告：這次快在哪、下一步怎麼做",
        date: Date.new(2026, 9, 4),
        type: :post,
        url: "https://claude.ai/code/artifact/e01b7146-94e1-4ac5-96be-9586bf0e7633",
    ...
    "PDRN" => [
      {
        ...
        type: :post,
        url: "https://claude.ai/artifact/LobZnote6Ajd3nipxYuxiL",
      ...
      },
      {
        ...
        date: Date.new(2026, 9, 18),
        type: :post,
        url: "https://claude.ai/artifact/SLbaYA2NxAPCfptem1zCNY",
        desc: "老闆決策版：近5場獨立主打D0–D1同口徑比較（買家/營收排第5、客單價$15,320排第3、新客占比1.9%最低）、逐時賣速、滿$2萬送1瓶的效果（85%的10瓶客加購過門檻）、用量週期（每瓶10–15天）與回購時程、執行建議",
      },
      {
        title: "四產品全買名單：穀胱甘肽・冰晶蕃茄・膠原蛋白・PDRN",
        date: Date.new(2026, 9, 21),
        type: :post,
        url: "https://claude.ai/artifact/SWrSFkuoinyDX6YdpWzsms",
        desc: "跨產品名單：全站歷史中四產品都買過的35位核心客，依四產品合計消費排序，黑卡+金卡占69%，含全站終身消費對照",
      },
      {
        title: "三產品都買、但沒買 PDRN 的名單",
        date: Date.new(2026, 9, 21),
        type: :post,
        url: "https://claude.ai/artifact/TEDYCicGJ8R3gtEYffiSfk",
        desc: "PDRN 補打名單：穀胱甘肽/冰晶蕃茄/膠原蛋白三產品都買過、未買PDRN的144位，依三產品合計消費排序，是四產品全買名單的4.1倍",
      },
    ],
  }.freeze
