...
class ProductReportsController < ApplicationController
  ...
  # buyers_last_year／buyers_this_year：對比基準的原始買家數（新客增加、舊客回購等百分比都是從這兩個數字算出來的）。
  # period：這兩個數字實際涵蓋的期間，大部分產品是「2025全年 vs 2026至今(1~8/17)」，
  #   膠原蛋白因缺貨改用「2025年1~5月 vs 2026年1~5月」，新上市產品用「上市首月/首週 vs 之後累計」。
  ...
  SUMMARY = [
    { product: "代謝錠",   status: :declining, period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 2771, buyers_this_year: 1410,
      new_customers: 705, retained_customers: 705, retention_pct: 25.4,
      fully_gone: 1662, fully_gone_pct: 80.4, switched_product: 404, switched_pct: 19.6,
      note: "失去專屬直播場次，2026年0場主打" },
    { product: "膠原蛋白", status: :declining, period: "2025年1~5月 vs 2026年1~5月（缺貨92天，改用同期公平口徑）", buyers_last_year: 1409, buyers_this_year: 338,
      new_customers: 190, retained_customers: 148, retention_pct: 10.5,
      fully_gone: 739, fully_gone_pct: 58.6, switched_product: 522, switched_pct: 41.4,
      note: "缺貨92天＋失去專場，跌幅四產品最深" },
    { product: "薑黃",     status: :watch,     period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 1885, buyers_this_year: 1095,
      new_customers: 597, retained_customers: 498, retention_pct: 26.4,
      fully_gone: 1001, fully_gone_pct: 72.2, switched_product: 386, switched_pct: 27.8,
      note: "買家流失73.6%，但大宗送贈拉高客單價使營收+17.3%" },
    { product: "全能",     status: :declining, period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 1791, buyers_this_year: 974,
      new_customers: 509, retained_customers: 465, retention_pct: 26.0,
      fully_gone: 893, fully_gone_pct: 67.3, switched_product: 433, switched_pct: 32.7,
      note: "久久才主打一次，黑卡回頭率四產品最高" },
    { product: "美白",     status: :declining, period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 1192, buyers_this_year: 97,
      new_customers: 44,  retained_customers: 53,  retention_pct: 4.4,
      fully_gone: 598, fully_gone_pct: 52.5, switched_product: 541, switched_pct: 47.5,
      note: "2026年零曝光，回頭率全產品最低，但換產品的人消費力反增4倍" },
    { product: "魚油",     status: :declining, period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 508, buyers_this_year: 282,
      new_customers: 151, retained_customers: 131, retention_pct: 25.8,
      fully_gone: 140, fully_gone_pct: 37.1, switched_product: 237, switched_pct: 62.9,
      note: "流失中最溫和，62.9%只是換產品沒有真的流失" },
    { product: "清纖粉",   status: :growing,   period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 722, buyers_this_year: 655,
      new_customers: 425, retained_customers: 230, retention_pct: 31.9,
      fully_gone: 237, fully_gone_pct: 48.2, switched_product: 255, switched_pct: 51.8,
      note: "唯一買家數、營收雙成長，回頭率也最高" },
    { product: "私密粉",   status: :new,       period: "2025/09上市首月(253人) vs 之後累計回購", buyers_last_year: 253, buyers_this_year: nil,
      new_customers: nil, retained_customers: 103, retention_pct: 40.7,
      fully_gone: 38, fully_gone_pct: 25.3, switched_product: 112, switched_pct: 74.7,
      note: "2025/09上市，無完整去年可比；舊客數＝上市首月253人裡後續有回購的人數" },
    { product: "蝦紅素",   status: :declining, period: "2025全年 vs 2026至今(1~8/17)", buyers_last_year: 744, buyers_this_year: 381,
      new_customers: 203, retained_customers: 178, retention_pct: 23.9,
      fully_gone: 308, fully_gone_pct: 54.4, switched_product: 258, switched_pct: 45.6,
      note: "2025年3場專場，2026年掛零" },
    { product: "維DK鈣",   status: :new,       period: "2025/12上市首週(157人) vs 2026全年累計(255人)", buyers_last_year: 157, buyers_this_year: 255,
      new_customers: 198, retained_customers: 57,  retention_pct: 36.3,
      fully_gone: 12, fully_gone_pct: 12.0, switched_product: 88, switched_pct: 88.0,
      note: "2025/12上市，無完整去年可比；連續3個月(6~8月)零訂單，待確認原因" },
    { product: "面膜",     status: :growing,   period: "2025全年(2025/08上市) vs 2026至今(1~8/17)", buyers_last_year: 325, buyers_this_year: 336,
      new_customers: 254, retained_customers: 82,  retention_pct: 25.2,
      fully_gone: 86, fully_gone_pct: 35.4, switched_product: 157, switched_pct: 64.6,
      note: "營收+219%，主要靠客單價拉高" },
    { product: "穀胱甘肽", status: :new,       period: "2026/01上市，無去年可比", buyers_last_year: nil, buyers_this_year: 536,
      new_customers: nil, retained_customers: nil, retention_pct: nil,
      fully_gone: nil, fully_gone_pct: nil, switched_product: nil, switched_pct: nil,
      note: "2026/01上市，無完整去年可比；上市→回落→再衝量的雙峰型" },
    { product: "益生菌",   status: :new,       period: "2026/02上市，無去年可比", buyers_last_year: nil, buyers_this_year: 620,
      new_customers: nil, retained_customers: nil, retention_pct: nil,
      fully_gone: nil, fully_gone_pct: nil, switched_product: nil, switched_pct: nil,
      note: "2026/02上市，無完整去年可比；三個新品裡曝光最頻繁、買氣最穩" },
    { product: "冰晶番茄", status: :new,       period: "2026/07才上市，無去年可比", buyers_last_year: nil, buyers_this_year: 147,
      new_customers: nil, retained_customers: nil, retention_pct: nil,
      fully_gone: nil, fully_gone_pct: nil, switched_product: nil, switched_pct: nil,
