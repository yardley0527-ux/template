Rails.application.routes.draw do
  ...
  resources :koc_contracts, only: [:index, :update]
  ...
  post '/message_list_recipients/update_field', to: 'message_lists#update_recipient_field', as: :update_message_list_recipient_field
