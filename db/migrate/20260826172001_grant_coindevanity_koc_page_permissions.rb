# social／crm 角色開放 coindevanity_kocs 業配名單頁，跟其他品牌一致。
class GrantCoindevanityKocPagePermissions < ActiveRecord::Migration[7.1]
  ...
  def down
    ...
    MigrationPagePermission.where(role_id: role_ids, controller_name: "coindevanity_kocs").destroy_all
  end
end
