# Body Goals（bodygoalstw）業配名單，跟 relove_kocs 同一套結構。
class CreateBodyGoalsKocs < ActiveRecord::Migration[7.1]
  def change
    create_table :body_goals_kocs do |t|
    ...
    add_index :body_goals_kocs, :ig_username, unique: true
  end
end
