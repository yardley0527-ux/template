# 好好生醫（betterbio_official）業配名單，跟 relove_kocs 同一套結構。
class CreateBetterbioKocs < ActiveRecord::Migration[7.1]
  def change
    create_table :betterbio_kocs do |t|
    ...
    add_index :betterbio_kocs, :ig_username, unique: true
  end
end
