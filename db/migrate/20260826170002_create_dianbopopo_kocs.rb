# dianbopopo 業配名單，跟 relove_kocs 同一套結構。
class CreateDianbopopoKocs < ActiveRecord::Migration[7.1]
  def change
    create_table :dianbopopo_kocs do |t|
    ...
    add_index :dianbopopo_kocs, :ig_username, unique: true
  end
end
