...
ActiveRecord::Schema[7.1].define(version: 2026_09_09_085807) do
  ...
  create_table "akimia_kocs", force: :cascade do |t|
  ...
  create_table "korean_brand_leads", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "follow_up"
    t.string "status", default: "待聯絡", null: false
  end
  ...
  create_table "message_list_recipients", force: :cascade do |t|
    ...
    t.boolean "content_usage_status", default: false, null: false
    t.boolean "content_restock_reminder", default: false, null: false
    t.boolean "content_product_education", default: false, null: false
    t.boolean "content_promotion_notice", default: false, null: false
    t.boolean "content_upgrade_reminder", default: false, null: false
  ...
  create_table "order_gift_records", force: :cascade do |t|
    ...
    t.boolean "first_purchase_message_sent", default: false, null: false
    ...
    t.boolean "crm_maintenance_unread", default: false, null: false
